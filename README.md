...
textKaggle bird-call metadata + audio
        │
        ▼
┌─────────────────────────────────┐
...
textDL_Term-Project_Bird-Classification/
...
🚀 Getting Started
Prerequisites
Bashpip install numpy pandas matplotlib seaborn plotly scikit-learn
...
Put the Kaggle bird-call files under data/
Open the notebooks in order: 1 → 2 → 3 → 4 → 5
...
Project: DL_Term-Project_Bird-Classification
